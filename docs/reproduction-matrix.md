...
| Agentic rollout | <=4 retrieval interaction turns | Environment and action masking contract implemented | veRL v0.9.1 custom agent loop remains GPU-backend work |
...
| Student models | Qwen3-1.7B and Qwen3-4B | Configured | GPU training pending |
